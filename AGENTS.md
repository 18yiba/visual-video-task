...
- v1 retains 18 video-bound checks; v2 retains 9 checks about every ten net minutes, immediately followed by F/J fatigue, ordinary-video F/J liking, and seven-point valence/arousal. Partial trials replay and resubmit as before.
- Fatigue is a literature-inspired study-specific binary item, not a validated scale. Preserve source/review status on questions.
