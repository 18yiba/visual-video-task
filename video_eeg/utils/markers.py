...
TRIGGER_REFERENCE = {
    ...
    134: "blank_on — 空屏开始",
    135: "blank_off — 空屏结束",
    136: "break_start — trial 间固定休息开始",
    137: "break_end — trial 间固定休息结束",
...
class TriggerBoxMarkerBackend(MarkerBackend):
    ...
    def __init__(self, serial_port: str, *, timeout_sec: float = 1.5) -> None:
        from video_eeg.devices.collect.triggerBox import TriggerBox
