...
**实验室安装版：[下载 Windows EXE 1.0.1](https://github.com/18yiba/visual-video-task/releases/download/desktop-v1.0.1/VisualVideoTask-Setup-Windows-x64.exe)** · [发布说明与 SHA256](https://github.com/18yiba/visual-video-task/releases/tag/desktop-v1.0.1)
...
本次推荐使用上方 Windows EXE 1.0.1；安装和首次迁移结束后，日常采集无需连接交付硬盘。已有 v1 继续选择 v1，不因安装总范式而改成 v2；只有研究安排明确需要 v2 时才用新协议和相应被试记录。
