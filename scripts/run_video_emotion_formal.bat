...
if not defined VIDEO_EEG_EMOTION_CONFIG set "VIDEO_EEG_EMOTION_CONFIG=video_emotion_config.yaml"
"%PYTHON_EXE%" -m video_eeg.experiment.emotion_runner --config "%ROOT%video_eeg\config\%VIDEO_EEG_EMOTION_CONFIG%" --real-eeg --device-type brainco --brainco-transport sdk %*
if errorlevel 1 (
    echo.
