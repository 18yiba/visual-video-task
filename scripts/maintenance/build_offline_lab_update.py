...
def build(destination):
    ...
    paths = [p for p in source_files() if p.suffix=='.py' and p.is_relative_to(ROOT/'video_eeg')]
...
'''
    ...
    shutil.copy2(ROOT / 'docs/operations/OFFLINE_UPDATE.md', target / '离线更新操作说明.md')
    (target / 'docs').mkdir(exist_ok=True)
    shutil.copy2(ROOT / 'docs/maintenance/CHANGELOG.md', target / 'docs/CHANGELOG.md')
