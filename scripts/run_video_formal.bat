...
if not defined VIDEO_EEG_CONFIG set "VIDEO_EEG_CONFIG=video_config.yaml"
"%PYTHON_EXE%" -m video_eeg.experiment.video_runner --config "%ROOT%video_eeg\config\%VIDEO_EEG_CONFIG%" --real-eeg --device-type brainco --brainco-transport sdk
if errorlevel 1 (
    echo.
